...
export default defineConfig(({ mode }) => {
  ...
  const securityHeaders = {
    ...
    "Referrer-Policy":
      env.VITE_SECURITY_REFERRER_POLICY || "strict-origin-when-cross-origin",
    "Permissions-Policy":
      env.VITE_SECURITY_PERMISSIONS_POLICY ||
    ...
    "Strict-Transport-Security":
      env.VITE_SECURITY_HSTS || "max-age=31536000; includeSubDomains; preload", // Força requisição HTTPS (certificado)
  };
