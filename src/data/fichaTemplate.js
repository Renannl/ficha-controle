...
export const OPERACOES = {
  ...
  '80': {
    ...
    items: [
      { id: 1,  sessao: '52-T2', descricao: 'DE-PARA PARA RETIRADA DO DISJUNTOR' },
  ...
  '90': {
    ...
    items: [
      ...
      { id: 2,  descricao: 'Conferir aperto de todas as conexões (Amostragem).' },
      { id: 3,  descricao: 'Verificar presença de esquemas elétricos e manuais.' },
      { id: 4,  descricao: 'Conferir placa de identificação e etiquetas de advertência.' },
      { id: 5,  descricao: 'Inspeção visual de pintura e acabamentos metálicos.' },
...
export const INSTRUMENTOS_TAF = [
  { id: 'alicate',   nome: 'Alicate Amperímetro Digital FLUKE', serie: '62862036MV' },
  { id: 'megger',    nome: 'Megômetro Digital Minipa MI-2552', serie: '2976519' },
  { id: 'paquimetro', nome: 'Paquimetro Digital STANDARD GAGE', serie: '5J0037201' },
...
export function createEmptyFicha(operacaoCodigo = DEFAULT_OPERACAO) {
  ...
  return {
    ...
    tafData: op.isTaf ? {
      ...
      instrumentosSelecionados: ['alicate', 'megger', 'paquimetro', 'torque', 'trena'],
      megger: {
        rs: '', st: '', rt: '', rn: '', sn: '', tn: '', rgnd: '', sgnd: '', tgnd: '', ngnd: '', tensaoAplicada: ''
      },
      hiPot: {
        tensaoAplicada: '', leakageR: '', leakageS: '', leakageT: ''
      },
