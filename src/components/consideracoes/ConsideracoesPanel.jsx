...
export default function ConsideracoesPanel({
  ficha,
  onUpdateHeader,
  onUpdateFotoData,
}) {
  ...
  return (
    <div className="info-section bg-card card-glow">
      <ConsideracoesHeaderFields
        ficha={ficha}
        onUpdateHeader={onUpdateHeader}
      />

      <ConsideracoesTable
        verificacoes={fotoData.verificacoes}
        onUpdateFotoData={onUpdateFotoData}
      />

      <ConsideracoesObservacoes
        observacoes={ficha.observacoes}
        onUpdateHeader={onUpdateHeader}
      />

      <ConsideracoesFooterFields
        fotoData={fotoData}
        onUpdateFotoData={onUpdateFotoData}
      />
    </div>
